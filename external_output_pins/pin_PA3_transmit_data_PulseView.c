...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_3|GPIO_PIN_7|TEST_PIN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PC3 PC7 TEST_PIN_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_3|GPIO_PIN_7|TEST_PIN_Pin;
